...
import type { OrderChargesFreight } from './OrderChargesFreight';
import {
    OrderChargesFreightFromJSON,
    OrderChargesFreightFromJSONTyped,
    OrderChargesFreightToJSON,
    OrderChargesFreightToJSONTyped,
} from './OrderChargesFreight';
import type { OrderChargesOtherInner } from './OrderChargesOtherInner';
import {
    OrderChargesOtherInnerFromJSON,
    OrderChargesOtherInnerFromJSONTyped,
    OrderChargesOtherInnerToJSON,
    OrderChargesOtherInnerToJSONTyped,
} from './OrderChargesOtherInner';
...
export interface OrderCharges {
    /**
     * 
     * @type {OrderChargesFreight}
     * @memberof OrderCharges
     */
    freight?: OrderChargesFreight;
    /**
     * 
     * @type {Array<OrderChargesOtherInner>}
     * @memberof OrderCharges
     */
    other?: Array<OrderChargesOtherInner>;
    /**
     * 
     * @type {OrderChargesFreight}
     * @memberof OrderCharges
     */
    total?: OrderChargesFreight;
}

/**
 * Check if a given object implements the OrderCharges interface.
 */
export function instanceOfOrderCharges(value: object): value is OrderCharges {
    return true;
}

export function OrderChargesFromJSON(json: any): OrderCharges {
    return OrderChargesFromJSONTyped(json, false);
}

export function OrderChargesFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderCharges {
    if (json == null) {
        return json;
    }
    return {
        
        'freight': json['freight'] == null ? undefined : OrderChargesFreightFromJSON(json['freight']),
        'other': json['other'] == null ? undefined : ((json['other'] as Array<any>).map(OrderChargesOtherInnerFromJSON)),
        'total': json['total'] == null ? undefined : OrderChargesFreightFromJSON(json['total']),
    };
}

export function OrderChargesToJSON(json: any): OrderCharges {
    return OrderChargesToJSONTyped(json, false);
}

export function OrderChargesToJSONTyped(value?: OrderCharges | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'freight': OrderChargesFreightToJSON(value['freight']),
        'other': value['other'] == null ? undefined : ((value['other'] as Array<any>).map(OrderChargesOtherInnerToJSON)),
        'total': OrderChargesFreightToJSON(value['total']),
    };
}
