 ...
 * 
 * @export
 * @interface OrderChargesFreight
 */
export interface OrderChargesFreight {
    /**
     * 
     * @type {MultiCurrency}
     * @memberof OrderChargesFreight
     */
    amount?: MultiCurrency;
}

/**
 * Check if a given object implements the OrderChargesFreight interface.
 */
export function instanceOfOrderChargesFreight(value: object): value is OrderChargesFreight {
    return true;
}

export function OrderChargesFreightFromJSON(json: any): OrderChargesFreight {
    return OrderChargesFreightFromJSONTyped(json, false);
}

export function OrderChargesFreightFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderChargesFreight {
    if (json == null) {
        return json;
    }
    return {
...
export function OrderChargesFreightToJSON(json: any): OrderChargesFreight {
    return OrderChargesFreightToJSONTyped(json, false);
}

export function OrderChargesFreightToJSONTyped(value?: OrderChargesFreight | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
