...
/**
 * Shipper's reference number details.
 * @export
 * @interface ReferenceNumbers
 */
export interface ReferenceNumbers {
    /**
     * Reference number qualifier code.
     * @type {string}
     * @memberof ReferenceNumbers
     */
    qualifierCode?: string;
    /**
     * The reference number indicates the shipper's actual reference number.
     * @type {string}
     * @memberof ReferenceNumbers
     */
...
/**
 * Check if a given object implements the ReferenceNumbers interface.
 */
export function instanceOfReferenceNumbers(value: object): value is ReferenceNumbers {
    return true;
}

export function ReferenceNumbersFromJSON(json: any): ReferenceNumbers {
    return ReferenceNumbersFromJSONTyped(json, false);
}

export function ReferenceNumbersFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReferenceNumbers {
    if (json == null) {
        return json;
    }
    return {
        
        'qualifierCode': json['qualifierCode'] == null ? undefined : json['qualifierCode'],
        'referenceNumber': json['referenceNumber'] == null ? undefined : json['referenceNumber'],
    };
}

export function ReferenceNumbersToJSON(json: any): ReferenceNumbers {
    return ReferenceNumbersToJSONTyped(json, false);
}

export function ReferenceNumbersToJSONTyped(value?: ReferenceNumbers | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'qualifierCode': value['qualifierCode'],
