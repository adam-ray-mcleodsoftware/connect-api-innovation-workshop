 ...
 * 
 * @export
 * @interface OrderProgressUpdatePosition
 */
export interface OrderProgressUpdatePosition {
    /**
     * The latitude of the event.
     * @type {number}
     * @memberof OrderProgressUpdatePosition
     */
    latitude?: number;
    /**
...
/**
 * Check if a given object implements the OrderProgressUpdatePosition interface.
 */
export function instanceOfOrderProgressUpdatePosition(value: object): value is OrderProgressUpdatePosition {
    return true;
}

export function OrderProgressUpdatePositionFromJSON(json: any): OrderProgressUpdatePosition {
    return OrderProgressUpdatePositionFromJSONTyped(json, false);
}

export function OrderProgressUpdatePositionFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderProgressUpdatePosition {
    if (json == null) {
        return json;
    }
    return {
...
export function OrderProgressUpdatePositionToJSON(json: any): OrderProgressUpdatePosition {
    return OrderProgressUpdatePositionToJSONTyped(json, false);
}

export function OrderProgressUpdatePositionToJSONTyped(value?: OrderProgressUpdatePosition | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
