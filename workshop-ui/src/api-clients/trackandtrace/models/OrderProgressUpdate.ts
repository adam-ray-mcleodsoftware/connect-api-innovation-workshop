...
import type { OrderProgressUpdatePosition } from './OrderProgressUpdatePosition';
import {
    OrderProgressUpdatePositionFromJSON,
    OrderProgressUpdatePositionFromJSONTyped,
    OrderProgressUpdatePositionToJSON,
    OrderProgressUpdatePositionToJSONTyped,
} from './OrderProgressUpdatePosition';

/**
 * 
 * @export
 * @interface OrderProgressUpdate
 */
export interface OrderProgressUpdate {
    /**
     * The event that occurred.
     * @type {string}
     * @memberof OrderProgressUpdate
     */
    event?: OrderProgressUpdateEventEnum;
    /**
    ...
    /**
     * 
     * @type {OrderProgressUpdatePosition}
     * @memberof OrderProgressUpdate
     */
    position?: OrderProgressUpdatePosition;
    /**
     * The distance in miles to the consignee.
     * @type {number}
     * @memberof OrderProgressUpdate
     */
    milesToConsignee?: number;
}
 ...
 * @export
 */
export const OrderProgressUpdateEventEnum = {
    Telemetry: 'Telemetry',
    Callin: 'Callin'
} as const;
export type OrderProgressUpdateEventEnum = typeof OrderProgressUpdateEventEnum[keyof typeof OrderProgressUpdateEventEnum];


/**
 * Check if a given object implements the OrderProgressUpdate interface.
 */
export function instanceOfOrderProgressUpdate(value: object): value is OrderProgressUpdate {
    return true;
}

export function OrderProgressUpdateFromJSON(json: any): OrderProgressUpdate {
    return OrderProgressUpdateFromJSONTyped(json, false);
}

export function OrderProgressUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderProgressUpdate {
    if (json == null) {
        return json;
    }
    return {
        ...
        'position': json['position'] == null ? undefined : OrderProgressUpdatePositionFromJSON(json['position']),
        'milesToConsignee': json['milesToConsignee'] == null ? undefined : json['milesToConsignee'],
    };
}

export function OrderProgressUpdateToJSON(json: any): OrderProgressUpdate {
    return OrderProgressUpdateToJSONTyped(json, false);
}

export function OrderProgressUpdateToJSONTyped(value?: OrderProgressUpdate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'position': OrderProgressUpdatePositionToJSON(value['position']),
        'milesToConsignee': value['milesToConsignee'],
    };
}
