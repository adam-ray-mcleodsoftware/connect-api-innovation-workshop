...
import type { OrderProgressUpdate } from './OrderProgressUpdate';
import {
    OrderProgressUpdateFromJSON,
    OrderProgressUpdateFromJSONTyped,
    OrderProgressUpdateToJSON,
    OrderProgressUpdateToJSONTyped,
} from './OrderProgressUpdate';
import type { OrderCharges } from './OrderCharges';
import {
    OrderChargesFromJSON,
    OrderChargesFromJSONTyped,
    OrderChargesToJSON,
    OrderChargesToJSONTyped,
} from './OrderCharges';
...
export interface OrderDetail {
    /**
     * Consignee reference number for this order. The ‘orders’ table in the LoadMaster database is the source for this field.
     * @type {string}
     * @memberof OrderDetail
     */
    consigneeReferenceNumber?: string;
    /**
     * The status for this order. The ‘stop’ table in the LoadMaster database is the source for this field.  
     * @type {string}
     * @memberof OrderDetail
     */
    status?: OrderDetailStatusEnum;
    /**
     * A unique identifier of the order to be returned.
     * @type {string}
     * @memberof OrderDetail
     */
    orderId?: string;
    /**
     * Reference id that uniquely identifies an edi load tender. The ‘orders’ table in the LoadMaster database is the source for this field.
     * @type {string}
     * @memberof OrderDetail
     */
    shipmentId?: string;
    /**
     * The customer code this order will be billed to. The ‘customer_id’ column in the ‘orders’ table of the LoadMaster database is source of this field. 
     * @type {string}
     * @memberof OrderDetail
     */
    ...
    /**
     * 
     * @type {Array<OrderProgressUpdate>}
     * @memberof OrderDetail
     */
    progressUpdates?: Array<OrderProgressUpdate>;
}
...
export type OrderDetailStatusEnum = typeof OrderDetailStatusEnum[keyof typeof OrderDetailStatusEnum];
...
export function OrderDetailFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderDetail {
    ...
    return {
        ...
        'consigneeReferenceNumber': json['consigneeReferenceNumber'] == null ? undefined : json['consigneeReferenceNumber'],
        'status': json['status'] == null ? undefined : json['status'],
        'orderId': json['orderId'] == null ? undefined : json['orderId'],
        'shipmentId': json['shipmentId'] == null ? undefined : json['shipmentId'],
        'billToCustomerCode': json['billToCustomerCode'] == null ? undefined : json['billToCustomerCode'],
        'shipperStop': json['shipperStop'] == null ? undefined : StopFromJSON(json['shipperStop']),
        'consigneeStop': json['consigneeStop'] == null ? undefined : StopFromJSON(json['consigneeStop']),
        'intermediateStops': json['intermediateStops'] == null ? undefined : ((json['intermediateStops'] as Array<any>).map(StopFromJSON)),
        'charges': json['charges'] == null ? undefined : OrderChargesFromJSON(json['charges']),
        'progressUpdates': json['progressUpdates'] == null ? undefined : ((json['progressUpdates'] as Array<any>).map(OrderProgressUpdateFromJSON)),
    };
}

export function OrderDetailToJSON(json: any): OrderDetail {
    return OrderDetailToJSONTyped(json, false);
}

export function OrderDetailToJSONTyped(value?: OrderDetail | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'billToCustomerCode': value['billToCustomerCode'],
        'shipperStop': StopToJSON(value['shipperStop']),
        'consigneeStop': StopToJSON(value['consigneeStop']),
        'intermediateStops': value['intermediateStops'] == null ? undefined : ((value['intermediateStops'] as Array<any>).map(StopToJSON)),
        'charges': OrderChargesToJSON(value['charges']),
        'progressUpdates': value['progressUpdates'] == null ? undefined : ((value['progressUpdates'] as Array<any>).map(OrderProgressUpdateToJSON)),
    };
}
