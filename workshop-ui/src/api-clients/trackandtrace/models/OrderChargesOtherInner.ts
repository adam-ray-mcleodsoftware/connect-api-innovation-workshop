...
import type { MultiCurrency } from './MultiCurrency';
import {
    MultiCurrencyFromJSON,
    MultiCurrencyFromJSONTyped,
    MultiCurrencyToJSON,
    MultiCurrencyToJSONTyped,
} from './MultiCurrency';

/**
 * 
 * @export
 * @interface OrderChargesOtherInner
 */
export interface OrderChargesOtherInner {
    /**
     * The code for the charge.
     * @type {string}
     * @memberof OrderChargesOtherInner
     */
    chargeCode?: string;
    /**
    ...
    description?: string;
    /**
     * The identifier indicating the party to which this charge is directed.
     * @type {string}
     * @memberof OrderChargesOtherInner
     */
    billToCode?: string;
...
/**
 * Check if a given object implements the OrderChargesOtherInner interface.
 */
export function instanceOfOrderChargesOtherInner(value: object): value is OrderChargesOtherInner {
    return true;
}

export function OrderChargesOtherInnerFromJSON(json: any): OrderChargesOtherInner {
    return OrderChargesOtherInnerFromJSONTyped(json, false);
}

export function OrderChargesOtherInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderChargesOtherInner {
    if (json == null) {
        return json;
    }
    return {
        
        'chargeCode': json['chargeCode'] == null ? undefined : json['chargeCode'],
        'description': json['description'] == null ? undefined : json['description'],
        'billToCode': json['billToCode'] == null ? undefined : json['billToCode'],
        'amount': json['amount'] == null ? undefined : MultiCurrencyFromJSON(json['amount']),
    };
}

export function OrderChargesOtherInnerToJSON(json: any): OrderChargesOtherInner {
    return OrderChargesOtherInnerToJSONTyped(json, false);
}

export function OrderChargesOtherInnerToJSONTyped(value?: OrderChargesOtherInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'billToCode': value['billToCode'],
        'amount': MultiCurrencyToJSON(value['amount']),
    };
}
